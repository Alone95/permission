...
CREATE TABLE `sys_acl` (
  ...
  `type` int(11) NOT NULL DEFAULT '1' COMMENT '类型 1:菜单2:按钮 3:其他',
  ...
  `operate_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后一次更新时间',
...
CREATE TABLE `sys_user` (
  ...
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '状态,1:正常 0:冻结态 2:删除',
  `remark` varchar(200) DEFAULT '' COMMENT '备注',
  `operator` varchar(20) NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后一次更新时间',
  `operate_ip` varchar(20) NOT NULL DEFAULT '' COMMENT '最后一次更新者的ip地址',
